...
/*:
 * @plugindesc v.1.2.1 [MV|MZ] [LITE] Allows you to change the mouse cursor, activate events by clicking, hovering, etc.
 * @author DKPlugins
 ...
 * @help
 ...
 ## See also
 ###===========================================================================
 1. Picture Choices (https://dk-plugins.ru/picture-choices/)
...
/*:ru
 * @plugindesc v.1.2.1 [MV|MZ] [LITE] Позволяет изменять курсор мыши, активировать события нажатием, наведением и др.
 * @author DKPlugins
 * @url https://dk-plugins.ru
 * @target MZ
 * @help
 ...
 ## Смотрите также
 ###=========================================================================
 1. Свечение Изображений (https://dk-plugins.ru/pictures-glow/)
...
Imported['DK_Mouse_System'] = '1.2.1';
...
(function() {
    ...
    TouchInput._onMouseMove = function(event) {
        ...
        if (Graphics.isInsideCanvas(x, y) && scene instanceof Scene_Map && scene.isActive() && !$gameMessage.isBusy()) {
            scene.checkEventsUnderMouse(this._x, this._y);
        } else {
            if (scene instanceof Scene_Map) {
                scene.hideMouseSystemObjects();
            }
    ...
    const MouseSystem_Scene_Map_stop = Scene_Map.prototype.stop;
    Scene_Map.prototype.stop = function() {
        MouseSystem_Scene_Map_stop.apply(this, arguments);
        this.hideMouseSystemObjects();
        TouchInput.resetCursorImage();
        TouchInput.showCursor();
    };

    Scene_Map.prototype.hideMouseSystemObjects = function() {
        if (this._mouseSystemSprite) {
